# Implementation of paper "ML-ANet: A Multi-label Image Classification Approach on Urban Scenes Using Adaptation Network" from Chinese Journal of Mechanical Engineering
